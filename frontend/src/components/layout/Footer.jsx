...
const Footer = () => {
  ...
  const linkClass = 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition-colors duration-200';
  const headingClass = 'text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider mb-4';
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            ...
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-xs">
              A better way to showcase projects, find jobs, and connect talent with opportunity.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              {isAuthenticated() ? (
                <>
                  <li><Link to="/projects/browse" className={linkClass}>Browse Projects</Link></li>
                  <li><Link to="/jobs" className={linkClass}>
                    {user?.role === 'recruiter' ? 'Manage Jobs' : 'Find Jobs'}
                  </Link></li>
                  <li><Link to="/members" className={linkClass}>Members</Link></li>
                </>
              ) : (
                <>
                  <li><Link to="/register" className={linkClass}>Get Started</Link></li>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a
                ...
                className="w-9 h-9 rounded-lg border border-gray-200 dark:border-gray-800 flex items-center justify-center hover:border-gray-400 dark:hover:border-gray-600 transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://github.com/arshhayerr/SkillHunt.git"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg border border-gray-200 dark:border-gray-800 flex items-center justify-center hover:border-gray-400 dark:hover:border-gray-600 transition-colors"
                aria-label="GitHub"
      ...
      <div className="border-t border-gray-100 dark:border-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <p className="text-center text-xs text-gray-400 dark:text-gray-500">
            &copy; {new Date().getFullYear()} SkillHunt. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
